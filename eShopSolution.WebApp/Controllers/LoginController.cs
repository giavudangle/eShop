...
namespace eShopSolution.WebApp.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterRequest registerRequest)
        {
            ...
            email.Send("giavudangle@gmail.com", user.ResultObj.Email, "XÁC NHẬN TÀI KHOẢN", confirmationLink);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel request)
        {
            ...
            var email = new EmailService.EmailService();
            email.Send("giavudangle@gmail.com", request.Email, "Link khôi phục mật khẩu", passwordResetLink);
